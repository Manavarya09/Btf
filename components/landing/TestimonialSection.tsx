...
import { cards } from "@/lib/landing/details";
...
export const TestimonialSection: React.FC = () => {
  ...
  useGSAP(() => {
    ...
    tesTl
      .to(".testimonials-section .ft-anim", {
        xPercent: 70 + 30,
        yPercent: -100,
      })
      .to(
        ".testimonials-section .st-anim",
        {
          xPercent: 25 + 30,
          yPercent: -100,
        },
  ...
  return (
    <section className="testimonials-section">
      ...
      <div className="absolute bottom-20 w-full h-auto py-2 flex justify-center items-center z-100">
        <button
          type="button"
          className="bg-[#e3a458] px-10 py-4 rounded-4xl"
        >
          Explore All
        </button>
      </div>
