...
import { nutrientLists } from "@/lib/landing/details";
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="nutrition-box">
          <div className="list-wrapper">
            {(isMobile ? nutrientLists.slice(0, 3) : nutrientLists).map(
              (nutrients, index, arr) => (
                <div key={index} className="relative flex-1 col-center">
                  ...
                  {index !== arr.length - 1 && <div className="spacer-border" />}
                </div>
              )
            )}
          </div>
