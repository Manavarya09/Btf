        ...
        <div className="w-full h-full md:px-30">
          <div className="msg-wrapper">
            ...
            <h1 className="second-message md:w-full w-[80%]">
              YOUR DAILY JOURNEY WITH ARYA MOBILITY OS
            </h1>
          </div>
          <div className="flex-center md:mt-20 mt-10">
            <div className="max-w-md px-10 flex-center overflow-hidden">
              <p className="text-sm md:text-right text-balance font-paragraph para-animate">
                ARYA Mobility OS brings EVs, transit, parking, scooters, and heat safety into one calm dashboard, so every trip across Dubai feels simple and in control.
              </p>
            </div>
          </div>
        </div>
