...
const NutritionSection = () => {
    ...
    return (
        <section className="nutrition-section">
            ...
            <video src={getVideo("hero-bg.mp4")} playsInline muted loop autoPlay className="big-img" />
                ...
                <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0">
                    ...
                    <div className="flex md:justify-end items-start md:translate-y-20 translate-y-10">
                                <div className="md:max-w-xs w-[70%]">
                                    <p className="text-sm md:text-right text-balance font-paragraph para-animate">ARYA is designed around real people, not just vehicles — balancing comfort, safety, and time so every journey feels human-friendly.</p>
                                </div>
                            </div>
                </div>
